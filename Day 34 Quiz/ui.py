...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_but =Button(image=true_image, highlightthickness=0, command=self.true_pressed)
        self.true_but.grid(row=2, column=0)

        false_image = PhotoImage(file="images/false.png")
        self.false_but = Button(image=false_image, highlightthickness=0,command=self.false_pressed)
